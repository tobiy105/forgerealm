...
- **Snapshot Date (UTC):** 2026-08-19
- **Project Start (first commit):** 2025-10-02
- **Total Commits:** 668
- **Tracked Files:** 288
- **Latest Commit:** a370642 - chore(backend): require DATABASE_URL, drop host/user/password fallback (#152) (2026-08-19)

### Recent Activity
- 2026-08-19 | a370642 | chore(backend): require DATABASE_URL, drop host/user/password fallback (#152)
- 2026-08-19 | 1595f52 | chore(backend): remove mysql2 and one-shot RDS migration tooling (#147)
- 2026-08-19 | 4a197d7 | content: Stall Session 14, Mini Mall stockist announcement, next-stall banner (#151)
- 2026-08-19 | 01988ae | content(work): swap in Ivysaur Planter and Blackthorn Manor (#148)
- 2026-08-19 | c43e27d | fix(shop): remove em dash from page title (#150)
