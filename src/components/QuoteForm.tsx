          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-6" aria-label="Instant quote form">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <label className="block">
                <span className="text-sm text-white/80 font-semibold">Name</span>
                <input
                  required
                  type="text"
                  name="name"
              ...
              <label className="block">
                <span className="text-sm text-white/80 font-semibold">Email</span>
                <input
                  required
                  type="email"
                  name="email"
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              <label className="block">
                <span className="text-sm text-white/80 font-semibold">Process</span>
              ...
              <label className="block">
                <span className="text-sm text-white/80 font-semibold">Material</span>
                <select className="mt-2 w-full rounded-xl border border-white/10 bg-black/40 px-3 py-2 outline-none focus:ring-2 focus:ring-brand-500">
                  <option>PLA</option>
                  <option>ABS</option>
              ...
              <label className="block">
                <span className="text-sm text-white/80 font-semibold">Finish</span>
                <select className="mt-2 w-full rounded-xl border border-white/10 bg-black/40 px-3 py-2 outline-none focus:ring-2 focus:ring-brand-500">
